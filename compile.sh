...
if [[ $OSTYPE == "linux"* ]]; then
    ...
    aria2c https://github.com/libarchive/bzip2/archive/refs/tags/bzip2-1.0.8.tar.gz
    ...
    cd $FR_BASE
    tar -zxvf bzip2-bzip2-1.0.8.tar.gz
    ...
    cd $FR_BASE
    cd ..
    ./autogen.sh $ALT_CONF_ARGS $CC_ARGS LDFLAGS="$LD_ARGS" LIBS="-ldl" --without-wifi
    make $JNUM
    cp usbmuxd2/usbmuxd bin/usbmuxd2
